        ...
        function atb_fs() {
            ...
            if ( !isset( $atb_fs ) ) {
                ...
                if ( ATB_HAS_PRO && file_exists( $fsStartPath ) ) {
                    ...
                    if ( ATB_HAS_FREE && file_exists( $bSDKInitPath ) ) {
    ...
    if ( !class_exists( 'ATBPlugin' ) ) {
        class ATBPlugin {
            public function __construct() {
                ...
                add_action(
                    'manage_animated-text-block_posts_custom_column',
                    [$this, 'animatedTextManageCustomColumns'],
                    10,
                    2
                );
            }
            ...
            function enqueueBlockAssets() {
                wp_register_style(
                    'animate',
                    ATB_DIR_URL . 'public/css/animate.min.css',
                    [],
                    '4.1.1'
                );
                wp_register_script(
                    'textillate',
                    ATB_DIR_URL . 'public/js/jquery.textillate.min.js',
                    ['jquery'],
                    ATB_VERSION,
                    true
                );
...
<?php 
            ...
            function adminEnqueueScripts() {
                ...
                wp_register_script(
                    'atb-view',
                    ATB_DIR_URL . 'build/view.js',
                    ['react', 'react-dom'],
                    ATB_VERSION
                );
                wp_register_style(
                    'fontAwesome',
                    ATB_DIR_URL . 'assets/css/font-awesome.min.css',
                    [],
                    ATB_VERSION
                );
                wp_register_style(
                    'atb-view',
                    ATB_DIR_URL . 'build/view.css',
                    ['fontAwesome'],
                    ATB_VERSION
                );
